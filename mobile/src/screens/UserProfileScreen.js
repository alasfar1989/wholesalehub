  ...
  return (
    ...
    >
      ...
      <View style={styles.listWrap}>
        ...
        {((tab === 'listings' && listings.length === 0) || (tab === 'ratings' && ratings.length === 0) || (tab === 'references' && references.length === 0)) && (
          <View style={styles.emptyWrap}>
            <Ionicons
              name={tab === 'listings' ? 'pricetag-outline' : tab === 'ratings' ? 'star-outline' : 'people-outline'}
              size={40}
              color={colors.textLight}
            />
            <Text style={styles.empty}>
              {tab === 'listings' ? 'No active listings' : tab === 'ratings' ? 'No reviews yet' : 'No references yet'}
            </Text>
          </View>
        )}
      </View>
